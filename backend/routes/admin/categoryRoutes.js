...
const {createCategory, getCategory, deleteCategory, updateCategoryIsActive} = require("../../controllers/admin/categoryController");
router.post("/add", validateRequest(categoryJoiSchema), createCategory);
router.get("/listing", getCategory);
router.delete("/delete", deleteCategory);
router.put("/update/:id", updateCategoryIsActive);
